...
selected_fortune = random.choice(fortunes) return f"Hello {name}, you {selected_fortune}"
...
if   name	 == "  main  ":
print("--- Running Python App ---") print(get_fortune("Rahul")) print(f"Dice Roll: {roll_dice()}") print(f"Is 42 even? {is_even(42)}")
